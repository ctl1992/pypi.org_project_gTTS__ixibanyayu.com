...
driver.get('file:///D:/Users/Administrator/PycharmProjects/ixibanyayu.com/a1.html')
a1csv = pandas.DataFrame(columns=['index_spainish', 'chinese only', 'spainish'])
index = 0
...
with open('a1.mp3', 'wb') as f:
    ...
    for tr in driver.find_element_by_css_selector("#post-8079 > div.post-content.container-fluid.d-flex.justify-content-center.mb-5 > div > div > table").find_elements_by_tag_name("tr"):
